...
void emitMIPSBinaryOperation(char* id1, char* OP, char* id2) {
	 ...
	 if(OP[0] == '+')
   {
   	 emitMIPSBinaryOperationADD(id1, OP, id2);
   }
    if(OP[0] == '-')
   {
   	 emitMIPSBinaryOperationSUB(id1, OP, id2);
   }
    if(OP[0] == '*')
   {
   	 emitMIPSBinaryOperationMUL(id1, OP, id2);
   }
    if(OP[0] == '/')
   {
   	 emitMIPSBinaryOperationDIV(id1, OP, id2);
   }
...
void emitMIPSBinaryOperation2(char* OP, char* id1) {
  	 ...
  	 if(OP[0] == '+')
   {
   	 emitMIPSBinaryOperation2ADD(OP, id1);
   }
    if(OP[0] == '-')
   {
   	 emitMIPSBinaryOperation2SUB(OP, id1);
   }
    if(OP[0] == '*')
   {
   	 emitMIPSBinaryOperation2MUL(OP, id1);
   }
    if(OP[0] == '/')
   {
   	 emitMIPSBinaryOperation2DIV(OP, id1);
   }
...
//Subtraction
void emitMIPSBinaryOperationSUB(char* id1, char* OP, char* id2) {
    char* targetRegister = getAvailableRegister();
...
//addition
void emitMIPSBinaryOperationADD(char* id1, char* OP, char* id2) {
    char* targetRegister = getAvailableRegister();
...
void emitMIPSBinaryOperationMUL(char* id1, char* OP, char* id2) {
    char* targetRegister = getAvailableRegister();
...
void emitMIPSBinaryOperationDIV(char* id1, char* OP, char* id2) {
    char* targetRegister = getAvailableRegister();
...
//addition
void emitMIPSBinaryOperation2ADD(char* OP, char* id1) {
    char* targetRegister = getAvailableRegister();
...
void emitMIPSBinaryOperation2SUB(char* OP, char* id1) {
    char* targetRegister = getAvailableRegister();
    ...
    // Perform the binary operation and store the result in the selected register
    fprintf(MIPScode, "sub %s, %s, %s\n", targetRegister, addReg, targetRegister);

    addReg = targetRegister;
}

void emitMIPSBinaryOperation2DIV(char* OP, char* id1) {
    char* targetRegister = getAvailableRegister();
...
void emitMIPSBinaryOperation2MUL(char* OP, char* id1) {
    char* targetRegister = getAvailableRegister();
