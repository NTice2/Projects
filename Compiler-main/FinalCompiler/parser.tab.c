...
{
       0,    62,    62,    68,    71,    74,    75,    78,    96,    97,
     100,   101,   104,   106,   163,   221,   252,   261,   273,   284,
     295,   304
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "NUMBER", "WRITE", "OP", "$accept", "Program",
  "DeclList", "Decl", "VarDecl", "StmtList", "Stmt", "Expr", "BinExpr", YY_NULLPTR
};
...
{
      -3,     8,     9,    -4,    10,    16,    -4,    -3,    -4,    -4,
      -1,    12,    13,     2,    -4,    -4,    -4,    -4,    -4,    -4,
      11,    14,    15,     4,     6,    18,    -4,    -4,    -4,    -4,
      -4
};
...
{
       1,     2,     3,     2,     3,     4,    20,     4,    26,    21,
      28,    27,    12,    29,    14,    13,    15,    18,    19,     0,
      23,     0,     0,    24,    25,    30,    16,    17
};
...
#line 252 "parser.y"
                ...
                (yyval.ast) = AST_assignmentWithBinExpr("=", (yyvsp[-2].string), (yyvsp[0].ast));
            }
#line 1361 "parser.tab.c"
    break;

  case 17: /* BinExpr: NUMBER OP NUMBER  */
#line 261 "parser.y"
                            { 
                printf("\n RECOGNIZED RULE: Binary expression with numbers\n");
                char str1[50], str2[50];
                sprintf(str1, "%d", (yyvsp[-2].number));
                sprintf(str2, "%d", (yyvsp[0].number));
                char opStr[2] = {(yyvsp[-1].op), '\0'};
                char* resultVar = generateTempVar();
                emitBinaryOperation(resultVar, str1, opStr, str2);
		emitMIPSBinaryOperation(str1, opStr, str2);
                (yyval.ast) = AST_binaryOperation(opStr, str1, str2);
                free(resultVar);
            }
#line 1378 "parser.tab.c"
    break;

  case 18: /* BinExpr: ID OP NUMBER  */
#line 273 "parser.y"
                       { 
                ...
                char opStr[2] = {(yyvsp[-1].op), '\0'};
                char* resultVar = generateTempVar();
                emitBinaryOperation(resultVar, (yyvsp[-2].string), opStr, str);
		emitMIPSBinaryOperation(resultVar,opStr, str);
                (yyval.ast) = AST_binaryOperation(opStr, (yyvsp[-2].string), str);
                free(resultVar);
            }
#line 1394 "parser.tab.c"
    break;

  case 19: /* BinExpr: NUMBER OP ID  */
#line 284 "parser.y"
                       { 
                ...
                char opStr[2] = {(yyvsp[-1].op), '\0'};
                char* resultVar = generateTempVar();
                emitBinaryOperation(resultVar, str1, opStr, (yyvsp[0].string));
		emitMIPSBinaryOperation(str1, opStr, resultVar);
                (yyval.ast) = AST_binaryOperation(opStr, str1, (yyvsp[0].string));
                free(resultVar);
            }
#line 1410 "parser.tab.c"
    break;

  case 20: /* BinExpr: ID OP ID  */
#line 295 "parser.y"
                   { 
                printf("\n RECOGNIZED RULE: Binary expression with two variables\n");
                char opStr[2] = {(yyvsp[-1].op), '\0'};
                char* resultVar = generateTempVar();
                emitBinaryOperation(resultVar, (yyvsp[-2].string), opStr, (yyvsp[0].string));
		//emitMIPSBinaryOperation(resultVar, $1, opStr, $3);
                (yyval.ast) = AST_binaryOperation(opStr, (yyvsp[-2].string), (yyvsp[0].string));
                free(resultVar);
            }
#line 1424 "parser.tab.c"
    break;

  case 21: /* BinExpr: BinExpr OP NUMBER  */
#line 304 "parser.y"
                                    {
              ...
              char opStr[2] = {(yyvsp[-1].op), '\0'};
              char* resultVar = generateTempVar();
              emitBinaryOperation(resultVar, (yyvsp[-2].ast), opStr, str);
	      emitMIPSBinaryOperation2(opStr, str);
              (yyval.ast) = AST_binaryOperation(opStr, (yyvsp[-2].ast), str);
              free(resultVar);
          }
